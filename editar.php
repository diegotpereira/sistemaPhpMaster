        ...
        <fieldset>
            ...
            <form action="action_cliente.php" method="post" id="form-contato" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="cpf" class="form-control" id="cpf" maxlength="14" name="cpf" value="<?=$cliente->cpf?>" placeholder="Infome o CPF">
                ...
                <div class="form-group">
                    ...
                    <input type="celular" class="form-control" id="celular" maxlength="12" name="celular" value="<?=$cliente->celular?>" placeholder="Informe o celular">
